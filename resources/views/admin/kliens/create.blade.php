...
@section('content')
    <div class="bg-white rounded-lg shadow p-6 max-w-xl">
        ...
        <form action="{{ route('admin.kliens.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Logo Klien (opsional)</label>
