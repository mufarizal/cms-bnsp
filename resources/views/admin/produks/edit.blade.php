        ...
        <form action="{{ route('admin.produks.update', $produk) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="4"
                    class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400">{{ old('deskripsi', $produk->deskripsi) }}</textarea>
            </div>
            ...
            <div>
                ...
                @if ($produk->gambar)
                    <img src="{{ Storage::url($produk->gambar) }}" class="w-32 h-32 object-cover rounded mb-2">
