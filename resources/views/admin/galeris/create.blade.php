...
@section('content')
    <div class="bg-white rounded-lg shadow p-6 max-w-xl">
        ...
        <form action="{{ route('admin.galeris.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="judul" value="{{ old('judul') }}"
                    ...
                    placeholder="Contoh: Kegiatan Belajar Kelas N5">
            </div>
            ...
            <div>
                ...
                <textarea name="keterangan" rows="2"
                    class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400"
                    placeholder="Keterangan singkat foto...">{{ old('keterangan') }}</textarea>
            </div>
            ...
            <div>
                ...
                <p class="text-xs text-gray-400 mt-1">Format: JPG, PNG, WEBP. Maks 3MB.</p>
                <img id="preview" src="#" alt="Preview" class="mt-3 w-full h-48 object-cover rounded hidden">
            </div>
